...
- 👷‍♂️ Meddled with `Android (Daijishō)`, `Svelte (WebGL Editor)`, `Microservice (In-House Framework)`, `Embedded (ESP32)`, `SysAdmin (Linux, FreeBSD, Cisco...)`, `Graphics (WebGL, Geometric Modeling)`, `ML (PPO, ViT, YOLO...)` and more.
