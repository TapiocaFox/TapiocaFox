...
- [Note-G](https://github.com/TapiocaFox/Note-G): An Arduino UNO rhythm game project. You can edit your music sheet on web and upload it to Arduino through bluetooth. Format like Open Music XML is supported.
