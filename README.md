...
- 👷‍♂️ Meddled with `Android (Daijishō)`, `Svelte (WebGL Editor)`, `Microservice (In-House Framework)`, `Embbeded System (ESP32)`, `SysAdmin (Linux, FreeBSD, Cisco...)`, `Graphics (WebGL, Geometric Modeling)`, `Machine Learning (PPO, ViT, YOLO...)` and more.
